...
export const config = {
  ...
  images: {
    ...
    gallery: [
      { url: "/beauty/stefan-lehner-IYa5Dnj9qWE-unsplash.jpg", category: "Nageldesign" },
      { url: "/beauty/ellie-eshaghi-DtoWpHt2_d8-unsplash.jpg", category: "Maniküre" },
      { url: "/beauty/giorgio-trovato-gb6gtiTZKB8-unsplash.jpg", category: "Gel Nägel" },
      { url: "/beauty/chelson-tamares-SyCC0GQi5S4-unsplash.jpg", category: "Shellac" },
      { url: "/beauty/nail-art1.jpg", category: "Naturnägel" },
      { url: "/beauty/nail-art2.jpg", category: "Pedikure" },
      { url: "/beauty/nail-art3.jpg", category: "Maniküre" },
      { url: "/beauty/nail-art4.jpg", category: "Nagelkunst" },
    ],
  },

...
export const config = {
  ...
  images: {
    ...
    gallery: [
      { url: "/beauty/nails2.jpg", category: "Nageldesign" },
      { url: "/beauty/nails3.jpg", category: "Maniküre" },
      { url: "/beauty/nails5.jpg", category: "Gel Nägel" },
      { url: "/beauty/nails6.jpg", category: "Shellac" },

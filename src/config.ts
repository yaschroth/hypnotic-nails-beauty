...
export const config = {
  ...
  images: {
    ...
    gallery: [
      { url: "/beauty/nail-art1.jpg", category: "Nageldesign" },
      { url: "/beauty/nail-art2.jpg", category: "Maniküre" },
      { url: "/beauty/nail-art3.jpg", category: "Gel Nägel" },
      { url: "/beauty/nail-art4.jpg", category: "Shellac" },
      { url: "/beauty/nail-art5.jpg", category: "Naturnägel" },
      { url: "/beauty/nail-art6.jpg", category: "Pedikure" },
      { url: "/beauty/nail-art7.jpg", category: "Maniküre" },
      { url: "/beauty/pedicure2.jpg", category: "Nagelkunst" },
    ],
  },
